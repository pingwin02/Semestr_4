...
if __name__ == '__main__':
    ...
    raw_dataset = pd.read_csv(url, index_col='Date', parse_dates=True, usecols=['Date', 'Close'])
    ...
    dataset.plot(legend=False, figsize=(10, 5), color='red')

    plt.annotate('Premiera gry Cyberpunk 2077', xy=('2020-12-04', int(dataset.loc['2020-12-04'])),
